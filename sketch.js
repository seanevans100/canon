...
function preload() {
  ...
  boatSpriteSheet = loadImage("./assets/moving boat.png")
  ...
  waterSplashSpriteData = loadJSON("./assets/brokenBoat.json")
  brokenBoatSpriteData = loadJSON("./assets/waterSplash.json")
}
